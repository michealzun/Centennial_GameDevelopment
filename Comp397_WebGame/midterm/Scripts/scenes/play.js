...
(function (scenes) {
    var PlayScene = /** @class */ (function (_super) {
        ...
        PlayScene.prototype.spawnMap = function () {
        ...
        PlayScene.prototype.Update = function () {
            ...
            this.bushes.forEach(function (bush) {
                if (managers.Collision.Check(_this.player, bush))
                    _this.collide = true;
            });
            if (this.collide) {
            ...
            this.traps.forEach(function (trap) {
                if (managers.Collision.Check(_this.player, trap))
                    _this.collide = true;
            });
            if (this.collide) {
